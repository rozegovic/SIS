...
bool MsgSender::sendtoUser(td::INT4 a, td::String subject, td::String poruka, td::INT4 userID) {
...
bool MsgSender::sendtoMultipleUsers(td::INT4 a, td::String subject, td::String poruka, std::vector<td::INT4> userIDs) {
...
bool MsgSender::sendMsgtoUser(td::String subject, td::String poruka, td::INT4 userID)
{
	...
	bool a = sendtoUser(aid, subject, poruka, userID);
	return a;
}
...
{
	td::INT4 aid = Globals::_currentUserID;
	bool a = sendtoMultipleUsers(aid, subject, poruka, userIDs);
	return a;
}
